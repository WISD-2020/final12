  ...
  <div class="row text-center">
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer">
                <a href="#" class="btn btn-primary">工業GO</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer">
                <a href="#" class="btn btn-primary">北歐GO</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer">
                <a href="#" class="btn btn-primary">現代GO</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-100">
            <img class="card-img-top" src="img/Simple-room-style.jpg" alt="" width="500" height="325">
            <div class="card-body">
                <h4 class="card-title">Minimalism-style</h4>
                <p class="card-text">呈現事物最原本的樣貌，或在設計上刻意留白，消彌物品視覺上對觀看者的意識壓迫，喜愛簡單真實的你快來看看!</p>
            </div>
            <div class="card-footer">
                <a href="#" class="btn btn-primary">簡約GO</a>
            </div>
        </div>
    </div>
  </div>
